...
export const GeneralInfoSection = () => {
    ...
    return (
        ...
        <div className="w-full h-full flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 flex justify-start items-start md:items-center flex-col gap-8">
                <div className="text-xl md:font-bold">Профайл зураг</div>
                ...
                >
                    <Avatar className="w-[50px] md:w-[100px] h-[50px] md:h-[100px] !bg-white/10" w={useResponsiveButtonWidth() ? 120 : 200} src={avatarImg} h={useResponsiveButtonWidth() ? 120 : 200}> </Avatar>
